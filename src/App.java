 ...
 *
 * Note:
 * You will modify computePerimeter() over the course of this quiz. Completing
 * task 2 may cause task 1
 * to not work any longer. That's OK! Similarly, completing task 3 might cause
 * task 2 to no longer work.
 * ##############################################################################################
 * TASK 1:
 * Modify computePerimeter() so it will find the perimeter of a rectangle with
 ...
 *
 * 1. Instead of printing the perimeter, the perimeter is RETURNED to main (as
 * an int).
 *
 * STOP HERE FOR: 'B+'
 * ##############################################################################################
 ...
 * 2. Too large values (greater than 100) for width or height return a value of
 * -1
 *
 * STOP HERE FOR: 'A'
 * ##############################################################################################
...
public class App {
    ...
    public static int computePerimeter(String shape, int width, int height){
